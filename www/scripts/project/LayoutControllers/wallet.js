...
const ResetTabButtons = function(){
	...
	const tabAddMoneyBtn = runtime.getInstanceByUid(120);
	const tabWithdrawBtn = runtime.getInstanceByUid(123);
...
const OnLayoutLoaded = function(){
	...
	runtime.getInstanceByUid(146).text = "₹" + loginResponse.dailyLimit;
	runtime.getInstanceByUid(152).text = loginResponse.deductionCharges+"%";
}
...
function StartWithdrawUPILayer(){
	...
	const withdrawBtn = runtime.getInstanceByUid(126);
...
function StartWithdrawBankLayer(){
	...
	const withdrawBtn = runtime.getInstanceByUid(101);
...
function StartAddMoneyLayer(){
	...
	const ten = runtime.getInstanceByUid(14);
	const fifty = runtime.getInstanceByUid(138);
	const hundred = runtime.getInstanceByUid(144);
	
	amountInput = runtime.getInstanceByUid(231);
	const addMoneyBtn = runtime.getInstanceByUid(49);
...
API.GET(API.uri.WALLET_MONEY_URL(), (balanceResponse)=> {
		...
		runtime.getInstanceByUid(93).text = "₹ " + balanceResponse.gameMoney;
		runtime.getInstanceByUid(330).text = "₹ " + balanceResponse.bonusMoney;
		runtime.getInstanceByUid(331).text = "₹ " + balanceResponse.winningMoney;
		}
		catch(e){}
	}, null);
}
