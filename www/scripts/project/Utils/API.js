...
WALLET_MONEY_URL: () =>
        `${config.BASE_URL}${config.CLINT_API_URL}total-money-drux?token=${config.TOKEN}`,
    PASSBOOK_URL: () =>
    ...
    CONTEST_JOIN_URL: () =>
        `${config.BASE_URL}${config.CLINT_API_URL}drux/contest-join?token=${config.TOKEN}`,
    CONTEST_END_URL: () =>
    ...
    TNC_URL: () =>
		"https://minda.aimcomely.com/terms.html",
};
