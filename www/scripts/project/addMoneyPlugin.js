...
const BROWSERS_BUTTON_UID = [207, 208, 209, 240];
const BROWSERS_THUMBNAIL_UID = [241, 245,247 , 252];
const BROWSERS_APPNAME_UID = [242, 246, 249, 255];

const UPI_BUTTON_UID = [256, 257, 259, 261, 278, 279, 280, 281, 290, 291, 292, 293];
const UPI_THUMBNAIL_UID = [264, 270, 273, 276,282 , 284, 286, 288, 294, 296, 298, 300];
const UPI_APPNAME_UID = [265, 272, 274, 277, 283, 285, 287, 289, 295, 297, 299, 301];

const BACK_BTN_UID = 302;
const AMOUNT_UID = 187;
const STATUS_MESSAGE_UID = 325;
const STATUS_OKAY_BTN_UID = 323;
const CANCELPOPUP_CANCEL_BTN_UID = 307;
const CANCELPOPUP_STAY_BTN_UID = 310;
const STATUS_CLOSE_BTN_UID = 320;
const PROCESSING_TIMER_UID = 317;

const BROWSER_OPTIONS_UID = 303;
const UPI_OPTIONS_UID = 304;
